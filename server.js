...
- Keep sentences practical and educational`;
    ...
    if (forceFallback || synonyms.length === 0 || simple === "") {
      ...
      const ieltsFallback = {
        ...
        "progress": { synonyms: ["advancement", "development", "improvement", "growth", "achievement"], antonyms: ["decline", "regression", "failure"], simple: "She made great progress in her studies.", compound: "She made great progress, and her scores improved significantly.", complex: "Although there were many obstacles, her determination led to significant progress." },
        "important": { synonyms: ["significant", "crucial", "essential", "vital", "critical"], antonyms: ["unimportant", "trivial", "insignificant"], simple: "Education is important for everyone.", compound: "Education is important, and it shapes our future.", complex: "Because education is important, governments should invest more in schools." },
        "learn": { synonyms: ["study", "master", "acquire", "discover", "understand"], antonyms: ["forget", "ignore", "neglect"], simple: "I want to learn English.", compound: "I want to learn English, so I practice every day.", complex: "Although learning a new language is challenging, it opens many opportunities." },
        "work": { synonyms: ["job", "employment", "career", "task", "labor"], antonyms: ["rest", "leisure", "unemployment"], simple: "I have a lot of work to do.", compound: "I have a lot of work, but I will finish it today.", complex: "Although the work was demanding, he managed to complete it on time." },
        "time": { synonyms: ["moment", "period", "duration", "instance", "opportunity"], antonyms: ["eternity", "forever"], simple: "I don't have enough time.", compound: "I don't have enough time, so I need to hurry.", complex: "Although time is limited, we can still achieve our goals with proper planning." },
        "people": { synonyms: ["individuals", "society", "folk", "citizens", "population"], antonyms: [" nobody", "no one"], simple: "Many people live in cities.", compound: "Many people live in cities, and the population is growing.", complex: "Because people have different needs, cities must provide various services." },
        "good": { synonyms: ["excellent", "great", "beneficial", "positive", "outstanding"], antonyms: ["bad", "poor", "terrible"], simple: "This is a good book.", compound: "This is a good book, and I recommend it to everyone.", complex: "Although the book is good, some parts could be improved." },
        "bad": { synonyms: ["poor", "terrible", "awful", "negative", "inferior"], antonyms: ["good", "excellent", "great"], simple: "The weather is bad today.", compound: "The weather is bad, so we will stay indoors.", complex: "Although the weather is bad, we can still enjoy indoor activities." },
        "technology": { synonyms: ["innovation", "advancement", "machinery", "equipment", "automation"], antonyms: ["tradition", "old methods"], simple: "Technology has changed our lives.", compound: "Technology has changed our lives, making many tasks easier.", complex: "Although technology brings many benefits, it also has some negative effects." },
        "environment": { synonyms: ["surroundings", "ecosystem", "habitat", "nature", "climate"], antonyms: ["none"], simple: "We need to protect the environment.", compound: "We need to protect the environment, and everyone should play a role.", complex: "Because the environment is being damaged, governments must take action." },
        "health": { synonyms: ["wellness", "fitness", "wellbeing", "soundness", "vitality"], antonyms: ["illness", "disease", "sickness"], simple: "Exercise is important for health.", compound: "Exercise is important for health, and it should be part of daily routine.", complex: "Although many people know about health benefits, few exercise regularly." },
        "education": { synonyms: ["learning", "training", "knowledge", "instruction", "study"], antonyms: ["ignorance", "illiteracy"], simple: "Education is the key to success.", compound: "Education is the key to success, and it opens many doors.", complex: "Because education empowers people, it should be accessible to everyone." },
        "money": { synonyms: ["wealth", "cash", "funds", "income", "finance"], antonyms: ["poverty", "debt"], simple: "Money is important for living.", compound: "Money is important, but it cannot buy happiness.", complex: "Although money is necessary, it should not be the only goal in life." },
        "family": { synonyms: ["relatives", "kin", "household", "parents", "children"], antonyms: ["strangers", "enemies"], simple: "My family lives together.", compound: "My family lives together, and we support each other.", complex: "Because family is important, we should spend quality time with them." }
      };
